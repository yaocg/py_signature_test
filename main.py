...
def create_rsa_key(password="123456"):
    ...
    print('public_key:\n\t{}\n'.format(key.publickey().exportKey()))
...
def encrypt_and_decrypt_test(password="123456"):
    ...
    source = b"123456,abcdesd"
    en_data = base64.b64encode(cipher_rsa.encrypt(source))
    print("\n加密数据信息:\n\tsource:{}\n\tencrypt:{}".format(source, en_data))
...
if __name__ == '__main__':
    ...
    print('签名:\n\t{}\n'.format(signature))
    ok = rsa_signverify(message,signature)
    print('验签:\n\t{}\n'.format(ok))
